...
<iframe width="315" height="560" src="https://www.youtube.com/embed/YSzUb_FfaGQ" title="YouTube Short player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "Can you predict what AI search will recommend?",
  "description": "No. Google personalizes AI search results based on your Gmail, calendar, photos, and YouTube views, so two people get different brand recommendations.",
  "author": {
    "@type": "Person",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What data does Google use to personalize AI search?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Gmail content, calendar events, Google Photos, YouTube watch history, and any other Google account signal you have personalization turned on for. Christopher Penn notes that AI Overviews and AI Mode pull these in by default if personalization is enabled."
      }
    },
    {
      "@type": "Question",
      "name": "Does this mean AI visibility cannot be measured at all?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It cannot be measured by third-party software, but it can be measured at your own contact form. Christopher recommends a free-form How did you hear about us field, analyzed monthly with AI, to spot ChatGPT, Claude, Google, and Perplexity as referral sources."
      }
    },
    {
      "@type": "Question",
      "name": "Should I cancel my AI visibility tracking subscription?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If you are paying for software that claims to predict your AI visibility, yes. Christopher Penn says the typical spend is five to ten thousand dollars a month for data that cannot account for personalization, and is therefore not predictive of what any individual searcher actually sees."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "VideoObject",
  "name": "Can you predict what AI search will recommend?",
  "description": "No. Google personalizes AI search results based on your Gmail, calendar, photos, and YouTube views, so two people get different brand recommendations.",
  "thumbnailUrl": "https://i.ytimg.com/vi/YSzUb_FfaGQ/maxresdefault.jpg",
  "uploadDate": "2026-05-02T00:00:00-07:00",
  "contentUrl": "https://youtube.com/shorts/YSzUb_FfaGQ",
  "embedUrl": "https://www.youtube.com/embed/YSzUb_FfaGQ"
}
</script>
